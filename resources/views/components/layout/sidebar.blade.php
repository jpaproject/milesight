    ...
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="{{ route('dashboard.index') }}">
            <span class="logo" :class="sidebarToggle ? 'hidden' : ''">
                <img class="dark:hidden w-40" src={{ asset('assets/images/logo-grootech-long.png') }} alt="Logo" />
                <img class="hidden dark:block w-40" src={{ asset('assets/images/logo-grootech-long.png') }}
                    alt="Logo" />
            </span>

            <img class="logo-icon w-10" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src={{ asset('assets/images/logo-grootech.png') }} alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
