<aside :class="sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'"
    class="sidebar fixed left-0 top-0 z-9999 flex h-screen w-[250px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 duration-300 ease-linear dark:border-gray-800 dark:bg-black lg:static lg:translate-x-0">
    <!-- SIDEBAR HEADER -->
    <div :class="sidebarToggle ? 'justify-center' : 'justify-between'"
        ...
        <a href="index.html">
            ...
            <img class="logo-icon" :class="sidebarToggle ? 'lg:block' : 'hidden'"
                src={{ asset('assets/images/logo-icon.svg') }} alt="Logo" />
        </a>
    </div>
    <!-- SIDEBAR HEADER -->
                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li>
                        <a href="{{ route('areas.index') }}"
                            ...
                            <svg class="{{ request()->routeIs('areas.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                    ...
                    <li>
                        <a href="{{ route('devices.index') }}"
                            class="menu-item group {{ request()->routeIs('devices.*') ? 'menu-item-active' : 'menu-item-inactive' }}">
                            <svg class="{{ request()->routeIs('devices.*') ? 'menu-item-icon-active' : 'menu-item-icon-inactive ?>' }}"
                                width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 4v1m0 14v1m8-8h-1M5 12H4m15.36 6.36l-.7-.7M6.34 6.34l-.7-.7M6.34 17.66l-.7.7M17.66 6.34l.7-.7M12 8a4 4 0 100 8 4 4 0 000-8z" />
                            </svg>
                            <span class="menu-item-text" :class="sidebarToggle ? 'lg:hidden' : ''">
                                Device Management
                            </span>
