<x-app-layout>
    ...
    <div x-data="{ pageName: `Area Management` }">
        <x-breadcrumb />
    </div>
    ...
    <div x-data="{ createModal: {{ session('show_create_modal') ? 'true' : 'false' }}, deleteModal: false, areaId: null }"
        ...
        <div class="px-6 py-4 mb-5">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Area List</h3>
        ...
        <div class="overflow-x-auto px-6 py-4">
            <table id="areasTable" class="min-w-full border dark:border-gray-600 rounded">
        ...
        <div x-show="deleteModal" x-transition:enter="transition ease-out duration-300"
            ...
            <div @click.outside="deleteModal = false" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-full max-w-md">
                    ...
                    <p class="text-gray-600 dark:text-gray-300">Are you sure you want to delete this area?</p>
                    ...
                    <div class="mt-6 flex justify-end gap-2">
                        ...
                        <form method="POST" :action="`/areas/${areaId}`">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
